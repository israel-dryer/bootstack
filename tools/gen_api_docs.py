...
API_MODULES = {
    ...
    "style": {
        ...
        "exports": {
            ...
            "Bootstyle": "bootstack.style.bootstyle.Bootstyle",
            "BootstrapIcon": "ttkbootstrap_icons_bs.BootstrapIcon",
            "get_style": "bootstack.style.style.get_style",
...
def write_main_index():
    ...
    lines.extend([
        ...
        "",
        "# App",
        "app = bs.App(title=\"My App\", theme=\"darkly\")",
        "",
        "# Widgets",
        "button = bs.Button(app, text=\"Click\", bootstyle=\"success\")",
        "",
        "# Style",
        "bs.set_theme(\"cosmo\")",
        "",
