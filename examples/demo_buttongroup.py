...
class ButtonGroupDemo(bs.App):
    def __init__(self):
        ...
        bs.Label(self, text="Basic Horizontal ButtonGroup", font="-weight bold").pack(pady=(10, 5))

        file_ops = bs.ButtonGroup(self, accent='primary', density='compact')
        ...
        bs.Label(self, text="Vertical ButtonGroup", font="-weight bold").pack(pady=(10, 5))

        edit_ops = bs.ButtonGroup(self, orient='vertical', accent='success')
        ...
        # Primary
        primary = bs.ButtonGroup(style_frame, accent='primary')
        primary.add("Btn 1")
        primary.add("Btn 2")
        primary.add("Btn 3")
        ...
        # Info
        info = bs.ButtonGroup(style_frame, accent='info', variant='outline')
        info.add("Btn 1")
        info.add("Btn 2")
        info.add("Btn 3")
        ...
        # Danger
        danger = bs.ButtonGroup(style_frame, accent='danger', variant='ghost')
        danger.add("Btn 1")
        danger.add("Btn 2")
        danger.add("Btn 3")
        ...
        bs.Label(self, text="CheckToggle Group (Multi-Select)", font="-weight bold").pack(pady=(10, 5))

        format_group = bs.ButtonGroup(self, accent='primary')
        self.bold_var = bs.BooleanVar(value=True)
        self.italic_var = bs.BooleanVar(value=False)
        self.underline_var = bs.BooleanVar(value=False)

        format_group.add("Bold", widget_type=bs.CheckToggle, variable=self.bold_var,
                         command=lambda: self.show_format_state())
        format_group.add("Italic", widget_type=bs.CheckToggle, variable=self.italic_var,
                         command=lambda: self.show_format_state())
        format_group.add("Underline", widget_type=bs.CheckToggle, variable=self.underline_var,
                         command=lambda: self.show_format_state())
        format_group.pack(pady=5)

        self.format_label = bs.Label(self, text="Format: Bold")
        self.format_label.pack(pady=2)

        # --- 5. RadioToggle Group (Single-Select) ---
        bs.Label(self, text="RadioToggle Group (Single-Select)", font="-weight bold").pack(pady=(10, 5))

        align_group = bs.ButtonGroup(self, accent='info', variant='outline')
        self.align_var = bs.StringVar(value='left')

        align_group.add("Left", widget_type=bs.RadioToggle, variable=self.align_var, value='left',
                        command=lambda: self.show_align_state())
        align_group.add("Center", widget_type=bs.RadioToggle, variable=self.align_var, value='center',
                        command=lambda: self.show_align_state())
        align_group.add("Right", widget_type=bs.RadioToggle, variable=self.align_var, value='right',
                        command=lambda: self.show_align_state())
        align_group.pack(pady=5)

        self.align_label = bs.Label(self, text="Alignment: left")
        self.align_label.pack(pady=2)

        # --- 6. Mixed Widget Types (with DropdownButton) ---
        bs.Label(self, text="Mixed Widget Types - Toolbar Example", font="-weight bold").pack(pady=(10, 5))

        toolbar = bs.ButtonGroup(self, accent='secondary')
        ...
        bs.Label(self, text="Split Button Pattern", font="-weight bold").pack(pady=(10, 5))

        split_button_frame = bs.Frame(self)
        split_button_frame.pack(pady=5)

        # Split button for "Save" action
        save_split = bs.ButtonGroup(split_button_frame, accent='primary', density='compact')
        ...
        run_split = bs.ButtonGroup(split_button_frame, accent='success')
        ...
        # --- 6. With Custom Keys ---
        bs.Label(self, text="With Custom Keys (Disable/Enable Example)", font="-weight bold").pack(pady=(10, 5))

        keyed_group = bs.ButtonGroup(self, accent='secondary')
        ...
        bs.Label(self, text="Dynamic Add/Remove", font="-weight bold").pack(pady=(10, 5))

        self.dynamic_add_group = bs.ButtonGroup(self, accent='dark')
        ...
        add_remove_frame = bs.Frame(self)
        ...
        bs.Label(self, text="Widget Info", font="-weight bold").pack(pady=(10, 5))

        info_group = bs.ButtonGroup(self, accent='info')
