"""Publisher-Subscriber pattern implementation for bootstack.

This module implements a simple publisher-subscriber (pub-sub) pattern used
for theme change notifications and widget updates throughout bootstack.
...
Example:
    ```python
    from bootstack.publisher import Publisher, Channel
