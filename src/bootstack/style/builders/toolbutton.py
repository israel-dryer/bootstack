...
def build_solid_toolbutton_style(
    ...
    normal_img = recolor_element_image(image_key, accent_color, accent_color, accent_color)
    normal_focus_img = recolor_element_image(image_key, surface, accent_focus, accent_color)
    active_img = recolor_element_image(image_key, active, active, active)
    selected_img = recolor_element_image(image_key, selected, selected, selected)
    selected_focus_img = recolor_element_image(image_key, surface, accent_focus, selected)
...
def build_outline_toolbutton_style(
    b: BootstyleBuilderTTk, ttk_style: str, accent: str = None, **options
):
    """
    Configure the button style.
    ...
    normal_img = recolor_element_image(image_key, surface, accent_color, surface)
    normal_focus_img = recolor_element_image(image_key, surface, accent_focus, surface)
    selected_img = recolor_element_image(image_key, accent_color, accent_color, accent_color)
    selected_focus_img = recolor_element_image(image_key, surface, accent_focus, accent_color)
    disabled_img = recolor_element_image(image_key, disabled, disabled, disabled)
    ...
    state_spec = dict(
        foreground=[
            ...
            ("selected !disabled", on_accent),
            ("pressed !disabled", on_accent),
            ("", accent_color),
        ],
    )
    state_spec = apply_icon_mapping(b, options, state_spec, icon_size(icon_only, density))
...
def build_ghost_toolbutton_style(
    b: BootstyleBuilderTTk, ttk_style: str, accent: str = None, **options
):
    """
    Configure the button style.
    ...
    surface = b.color(surface_token)
    surface_hover = (
        b.color(f"{surface_token}_hover")
        if b.colors.get(f"{surface_token}_hover")
        else b.subtle("secondary", surface)
    )
    ...
    normal_focus_img = recolor_element_image(image_key, surface, accent_color, surface)
    hover_img = recolor_element_image(image_key, surface_hover, surface_hover, surface_hover)
    selected_img = recolor_element_image(image_key, active, active, active)
    selected_pressed_img = recolor_element_image(image_key, accent_pressed, accent_pressed, accent_pressed)
    selected_focus_img = recolor_element_image(image_key, surface, accent_color, accent_focus)
    disabled_img = recolor_element_image(image_key, disabled, disabled, disabled)
