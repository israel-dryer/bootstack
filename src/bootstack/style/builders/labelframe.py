...
style color is only relevant for the border color of the labelframe.
"""
...
@StyleBuilderTtk.register_builder('default', 'TLabelframe')
def build_labelframe_style(b: StyleBuilderTtk, ttk_style: str, accent: str = None, **options):
