...
if TYPE_CHECKING:
    from bootstack.widgets._impl.composites.sidenav import SideNavGroup, SideNavHeader, SideNavSeparator
...
from bootstack.widgets._impl.composites.sidenav import SideNav
