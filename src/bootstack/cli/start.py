...
from bootstack.cli.templates import create_project
...
def add_parser(subparsers: argparse._SubParsersAction) -> None:
    ...
    parser = subparsers.add_parser(
        "start",
        help="Create a new bootstack project",
        description="Scaffold a new bootstack application with sensible defaults.",
    )
    parser.add_argument(
        "name",
