...
| `value` | `Union[datetime.time, str]` | `None` | Initial time value to display. Can be a time object or string |
| `value_format` | `str` | `'shortTime'` | Time format pattern for parsing and displaying times |
| `interval` | `int` | `30` | Time interval in minutes for dropdown items (e.g., 15, 30, 60) |
| `min_time` | `Union[datetime.time, str]` | `None` | Minimum time value for the dropdown list |
| `max_time` | `Union[datetime.time, str]` | `None` | Maximum time value for the dropdown list |
