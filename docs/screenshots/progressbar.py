...
def hero():
    with bs.App(title="ProgressBar", minsize=(720, 1), padding=20, gap=8, fill_items="x") as app:
...
def accents():
    with bs.App(title="ProgressBar — Accents", minsize=(720, 1), padding=20, gap=8, fill_items="x") as app:
