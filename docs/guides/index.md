...
- **[Architecture](../architecture/index.md)** explains how bootstack is structured at a foundational level — Tk/ttk internals and bootstack's enhancements. Read when integrating with raw Tk or debugging deep behavior.
- **[Tooling](../tooling/cli.md)** covers the CLI, project structure, and packaging.
